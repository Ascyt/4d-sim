...
public class VideoMovementHyperscene : Hyperscene
{
    ...
    {
        highlightedCell.connectedVertices[0].color = VideoMovementHypersceneInteractivity.Instance.highlightedCellColor;
