...
public struct Rotation4
{
    ...
    {
        Rotation4 newRot = Rotation4.zero.ApplyRotation(rotationEuler, true);
    ...
    {
        Rotation4 newRot = Rotation4.zero.ApplyRotation(new RotationEuler4(xw, yw, zw, xy, xz, yz), true);
        leftQuaternion = newRot.leftQuaternion;
        rightQuaternion = newRot.rightQuaternion;
    }
