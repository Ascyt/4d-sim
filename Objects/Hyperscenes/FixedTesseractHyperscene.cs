...
public class FixedTesseractHyperscene : Hyperscene
{
    ...
    private List<Hyperobject> _fixedObjects = new()
    {
        ...
        new Cube(new Vector4(0, 0, 0, 0), ConnectedVertices.ConnectionMethod.Solid, new Color(0f, 1f, 1f, 1f / 32f)),
        new Tesseract(new Vector4(0.5f, 0.5f, 0.5f, 0.5f), ConnectedVertices.ConnectionMethod.Solid, new Color(1f, 0f, 1f, 1f / 16f), 1f / 8f),
    };
