...
public class GroundHyperscene : Hyperscene
{
    ...
    {
        new Tesseract(new Vector4(0, -2f, 0, 0), ConnectedVertices.ConnectionMethod.Solid, new Color(0.5f, 0.5f, 0.5f, 0.5f), new Vector4(5, 3, 5, 5)),

        new C5(new Vector4(0, 0, 0, 0), ConnectedVertices.ConnectionMethod.Wireframe, Color.magenta, Vector4.one / 2f),
